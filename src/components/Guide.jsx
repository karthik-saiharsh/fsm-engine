...
const Guide = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-5 justify-center items-center px-5 py-5 w-150 h-fit bg-primary-bg border border-border-bg rounded-3xl shadow-[0px_0px_50px_0px_#000000]/70 select-none">
        {slides[i]}
...
function Page3() {
  return (
    <>
      ...
      <p className="font-github text-white w-150 text-center text-balance">
