...
export function epsilonClosure(nfa_graph, state_set) {
	...
	const closure = new Set(state_set);
	const stack = [...state_set];
...
export function nfa_acceptsString(nfa_graph, input_string) {
	...
	const instantaneous_desc = [[nfa_graph[start_state].name, input_string]];
...
export function validateString(str) {
	...
	if (engine_type === "DFA") {
		...
		const instantaneous_desc = [[graph[curr_state].name, str]];
